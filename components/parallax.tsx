...
const ParallaxText = ({ children, baseVelocity = 100, optionalClassName }: ParallaxProps) => {
  ...
  return (
    <div className="parallax">
      <motion.div className={`flex flex-nowrap whitespace-nowrap ${optionalClassName}`} style={{ x }}>
        <span>{children}</span>
        <span>{children}</span>
        <span>{children}</span>
        <span>{children}</span>
