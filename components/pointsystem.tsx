...
const PointSystem = ({ category }: { category: 'cardio' | 'fullbody' | 'toning' }) => {
    ...
    return (
        <article className='bg-primary-lighter rounded-lg m-2 p-2 flex items-center gap-8'>
            <Image src={thumbsUp} alt='from Blush by Pau Barbaro' className='w-[5rem] h-auto opacity-[80%]' />
            <div>
